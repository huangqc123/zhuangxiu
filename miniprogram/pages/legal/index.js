...
const TERMS_SECTIONS = [
  ...
  {
    title: '5. 用户责任',
    content: '因输入错误、单位混淆、未按提示复核、忽略专业边界、超出适用场景，或把概算作为采购及施工唯一依据而产生的差异、补退货、工期、费用或其他损失，由用户自行承担相应风险。'
  },
  {
    title: '6. 免责声明',
    content: '在法律允许的最大范围内，开发者不对因使用或无法使用本小程序产生的间接、附带、可避免损失，或因用户输入、产品规格、现场条件及施工差异产生的结果偏差承担责任；但法律法规规定不得排除或限制的责任，不受本条影响。'
  },
  {
    title: '7. 服务调整',
  ...
  {
    title: '8. 联系方式',
    content: '如对计算口径、协议或服务有疑问，可通过微信号 a1126204749 联系开发者。'
  }
]
